<template>
    <div>
        ...
        <div id="word-text-area">
            <el-input type="textarea" :rows="10" placeholder="Please imput something" v-model="textarea">
            </el-input>
            <div id="word-img">
            ...
            <div id="word-operation">
                <el-row>
                    <el-button type="primary" @click="onSubmit" round>Create word Cloud</el-button>
                    <el-button type="success" @click="onDownload" round>Download picture</el-button>
                </el-row>
            </div>
        </div>
    </div>
